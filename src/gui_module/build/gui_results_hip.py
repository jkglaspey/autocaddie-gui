...
def main(camera_holder_1 = None, camera_holder_2 = None, camera_holder_3 = None, camera_holder_4 = None, ser_out_ref = None, cameras_ref = None):
    ...
    def put_graph():
        ...
        global cur_cam_idx
        if cur_cam_idx == 0:
            if os.path.exists(r"neural_network\graphs\trimmed_out_0_angle_hip_act.png"):
                graph_image = Image.open(r"neural_network\graphs\trimmed_out_0_angle_hip_act.png")
            ...
            if os.path.exists(r"neural_network\graphs\trimmed_out_1_angle_hip_act.png"):
                graph_image = Image.open(r"neural_network\graphs\trimmed_out_1_angle_hip_act.png")
                photo_graph_image = ImageTk.PhotoImage(graph_image)
                rectangle_2 = canvas.create_image(411, 192, anchor="nw", image=photo_graph_image)
                canvas.rectangle_2 = photo_graph_image
                canvas.rectangle_image_2 = graph_image
            ...
            if os.path.exists(r"neural_network\graphs\skeleton_video0_angle_hip_pred.png"):
                graph_image = Image.open(r"neural_network\graphs\skeleton_video0_angle_hip_pred.png")
                photo_graph_image = ImageTk.PhotoImage(graph_image)
                rectangle_2 = canvas.create_image(411, 192, anchor="nw", image=photo_graph_image)
                canvas.rectangle_2 = photo_graph_image
                canvas.rectangle_image_2 = graph_image
            ...
            if os.path.exists(r"neural_network\graphs\skeleton_video1_angle_hip_pred.png"):
                graph_image = Image.open(r"neural_network\graphs\skeleton_video1_angle_hip_pred.png")
                photo_graph_image = ImageTk.PhotoImage(graph_image)
                rectangle_2 = canvas.create_image(411, 192, anchor="nw", image=photo_graph_image)
                canvas.rectangle_2 = photo_graph_image
                canvas.rectangle_image_2 = graph_image
    ...
    def update_video_loop():
        global terminate, video_1, video_2, video_3, video_4, fps, cur_frame, cur_cam_idx, pause
        cur_frame = 0
        while not terminate:
            if cur_cam_idx == 0:
                # Get from video 1
    ...
    def click_right_button():
        ...
        close_window(window, width, height, x, y, False)
        gui_results_shoulder.main(video_1, video_2, video_3, video_4, ser_out, cameras)
